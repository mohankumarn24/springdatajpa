...
public class CouponDataSourceConfig {
	...
	DataSourceProperties couponDataSourceProperties() {
	...
	LocalContainerEntityManagerFactoryBean couponEntityManagerFactoryBuilder(
	...
	PlatformTransactionManager couponTransactionManager(
